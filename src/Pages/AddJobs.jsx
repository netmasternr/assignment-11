                    ...
                    <div className='grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2'>
                        <div>
                            ...
                            <input
                                ...
                                name='Picture_URL'
                                type='text'
                                className='block w-full px-4 py-2 mt-2 text-white bg-white border border-gray-200 rounded-md  focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring'
                            />
                        </div>
                        <div>
                            <label className='text-white ' htmlFor='job_title'>
                        ...
                        <div className='flex flex-col gap-2 '>
                            ...
                            >
                                ...
                                <option
                                    ...
                                    value='Graphics Design'>remote</option>

                                <option

                                    value='Digital Marketing'>part_time</option>

                                <option

                                    value='Digital Marketing'>hybrid</option>
                            </select>
                        </div>
                        <div>
